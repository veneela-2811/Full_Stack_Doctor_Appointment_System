...
// when any of doctors,speciality,docId changes,this useeffect hook will be called
    useEffect(()=>{
  ...
  return (
   <div className='flex flex-col items-center gap-4 my-16 text-gray-900 md:mx-10'>
      ...
      {/* display the list of top doctors */}
      ...
      <button onClick={()=>{navigate('/doctors'); scrollTo(0) }} className='bg-blue-100 text-gray-600 px-12 py-3 rounded-full mt-10 '>more</button>
    </div>
  )
}
