...
const Appointment = () => {
  ...
  const bookAppointment=async()=>{
    //check if user is logged in or not by checking if token is there or not
    ...
    try {
      ...
      //destructure the date to store year,onth,day in diff variables
      ...
      if(data.success){
        ...
        //fetch doctor's data to know the slots already booked  by doctor
        getDoctorsData()
  ...
  return docInfo &&(
    ...
    <div className='sm:ml-72 sm:pl-4 mt-4 font-medium text-gray-700'>
      ...
      <button onClick={bookAppointment} className='bg-[#5f6FFF] text-white text-sm font-light px-14 py-3 rounded-full my-7'>Book an Appointment</button>
